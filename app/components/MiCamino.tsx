  ...
  return (
    <div className="bg-white">
        ...
        <div className="w-full min-h-screen h-auto xl:px-24 lg:px-24 md:px-24">
             ...
             <div className="contenedor-micamino  h-full xl:p-24 lg:p-8 p-8">
                    ...
                    <div className="micamino-2 flex justify-center">

                        <div className="">

                            <Image className="lg:w-[120px] lg::h-[120px] md:w-[120px] md:h-[120px] w-[85px] h-[85px] rounded-full border-2 border-black bg-white" src={'https://i.postimg.cc/2SrBtp0g/Luis-Avatar-icon.png'} alt={''} width={100} height={100} objectFit='cover'>
                    ...
                    <div className="micamino-5 xl:p-12 xl:px-6 lg:p-10 lg:px-4 md:px-2 md:pt-10 px-2 pt-8 border-l-2 lg:grid lg:justify-center lg:items-center">
                        ...
                        <div className="flex-col justify-center items-center">
                             ...
                             <h1 className="xl:text-3xl lg:text-2xl md:text-xl text-lg text-black font-oswald">
                              Mi Primer Videojuego
                             </h1>

                             <p className="xl:text-3xl lg:text-2xl md:text-xl text-lg text-black  font-darkergrotesque">
